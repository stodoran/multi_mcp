...
class DistributedTracing:
    ...
    def start_span(self, operation_name: str, parent_span_id: Optional[int] = None,
                  trace_id: Optional[int] = None) -> Span:
        """
        Start a new span
    ...
    def get_span_context(self, span_id: int) -> Optional[Dict]:
        """
